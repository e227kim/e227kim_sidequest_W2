...
- Blob starts on the left side of the screen
- Use 'A'/'D' or left/right arrow buttons to move left and right
- Use space bar, 'W', or up arrow button to jump
- Land blob on platforms
