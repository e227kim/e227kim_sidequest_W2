...
let blob3 = {
  ...
  wobble: 11, // 7 -> 11  makes the blob squishier looking and more alive
  wobbleFreq: 1.4, // 0.9 -> 1.4  blob breathes faster to look more excited
  ...
  maxRun: 5.2, // 40 -> 5.2 for more energetic movement
  ...
  // Friction
  frictionAir: 0.998, // 0.995 -> 0.0998 to make aerial movement smoother
  frictionGround: 0.92, // 0.88 -> 0.92 less drag, glides easier
};
...
function setup() {
  ...
  platforms = [
    ...
    { x: 120, y: floorY3 - 70, w: 140, h: 12 }, // low step - made lower and wider
    { x: 300, y: floorY3 - 105, w: 120, h: 12 }, // mid step - made lower and wider
    { x: 440, y: floorY3 - 150, w: 150, h: 12 }, // high step - made lower and wider
    { x: 520, y: floorY3 - 70, w: 100, h: 12 }, // return ramp - made lower and wider
  ];
...
function draw() {
  background(180, 220, 255); // Grey -> blue background for a bright blue sky

  // --- Draw all platforms ---
  fill(255, 245, 210); // Grey -> light yellow platforms
...
function drawBlobCircle(b) {
  fill(255, 255, 0); // blue -> yellow as yellow is the colour most commonly associated with joy
  beginShape();
